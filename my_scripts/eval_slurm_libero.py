...
#SBATCH --output=/home/daiyp/openpi/runs/logs/eval_{model_name}_{task_suite_name}-task{task_start_id}_{task_end_id}-%j.out
#SBATCH --gres=gpu:1
...
SESSION_NAME="Eval-{model_name}-{task_suite_name}-task{task_start_id}_{task_end_id}"

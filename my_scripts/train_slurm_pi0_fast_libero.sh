#!/bin/bash
#SBATCH --job-name=pi0_fast_libero_large_crosshair_dynamic_default_color_grpsen
#SBATCH --output=/home/daiyp/openpi/runs/logs/pi0_fast_libero_large_crosshair_dynamic_default_color_grpsen-%j.out
#SBATCH --gres=gpu:4
...
XLA_PYTHON_CLIENT_MEM_FRACTION=0.975 /nfs/turbo/coe-chaijy/daiyp/micromamba_gl/envs/openpi/bin/python  /home/daiyp/openpi/scripts/train.py pi0_fast_libero --exp-name=pi0_fast_libero_large_crosshair_dynamic_default_color_grpsen --batch-size=32 --overwrite --fsdp_devices=4  --checkpoint_base_dir  /home/daiyp/openpi/runs/ckpts   --assets_base_dir /home/daiyp/openpi/runs/assets --lerobot_repo_id libero_large_crosshair_dynamic_default_color_grpsen --no-apply-delta

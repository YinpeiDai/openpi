...
CUDA_VISIBLE_DEVICES=1 python examples/libero/run_libero_eval_batch.py  --model-name pi0-fast-ckpt30000 --task_suite_name libero_spatial  --task_start_id 2 --task_end_id 10 --port 8012

...
def eval_rlbench(args: Args) -> None:
    ...
    save_dir = os.path.join(args.save_path, args.task_name, args.model_name)
    os.makedirs(save_dir, exist_ok=True)
    save_dir_video = os.path.join(save_dir, "video")
    os.makedirs(save_dir_video, exist_ok=True)
    
    task_name = args.task_name
    if args.task_name == "close_jar":
        max_steps = 250
    elif args.task_name == "insert_onto_square_peg":
        max_steps = 300
    elif args.task_name == "light_bulb_in":
        max_steps = 380
    elif args.task_name == "meat_off_grill":
        max_steps = 240
    elif args.task_name == "open_drawer":
        max_steps = 150
    elif args.task_name == "push_buttons":
        max_steps = 210
    elif args.task_name == "stack_blocks":
        max_steps = 900
    elif args.task_name == "stack_cups":
        max_steps = 360
    else:
    ...
    print(f"Eval task name: {args.task_name }")        
